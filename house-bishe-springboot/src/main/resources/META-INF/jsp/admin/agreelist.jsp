...
<html>
	...
	$(document).ready(function(){
		$.post("<%=basePath%>admin/agreelist",function(data){//获取json数据
		var data = eval("("+data+")");
		tableInit(data);
	});
    ...
    <script>
        ...
        $(function () {
            $button.click(function () {//获取删除的多选框里里面的值,将值传给:url:"deleteMembers",
                ...
                $.ajax({
                	url:"<%=basePath%>admin/agreeDeletes",
                	data:{
        ...
        detail= function(agreement_id) {
        	window.location.href ="<%=basePath%>admin/getOneAgree/"+agreement_id+"?agreement_id="+agreement_id;
        };
