...
<html>
	...
	$(document).ready(function(){
		$.post("<%=basePath%>admin/houseCheckList",function(data){//获取json数据
		var data = eval("("+data+")");
		tableInit(data);
	});
...
<body>
    ...
    <script>
                ...
                columns: [{
                   ...
                   field: 'price',
                	...
                	formatter: function (value, row, index) {
                        ...
                        'click .getDetail': function (e, value, row, index) {
                           houseagree(row.house_id);//调用details(sno)
                        }
                    }
                },{//查看详细信息
                	field:'detail3',
                	...
                	formatter: function (value, row, index) {
                        ...
                        'click .getDetail': function (e, value, row, index) {
                        	houseDisagree(row.house_id);//调用details(sno) 
                        }
                    }
                }
        ...
        houseagree= function(house_id) {
        	window.location.href ="<%=basePath%>admin/houseagree/"+house_id+"?house_id="+house_id;
        };
        houseDisagree= function(house_id) {
        	window.location.href ="<%=basePath%>admin/houseDisagree/"+house_id+"?house_id="+house_id;
        };
