...
<input type="hidden" class="form-control" id="house_id"
				...
				<select id="house_id" name="house_id" class="form-control">
					<c:forEach var="house" items="${hlist}">
						<option value="${house.house_id}"
							<c:if test="${house.house_id==a.house_id}"> selected</c:if>><c:out
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="name"
					name="name" placeholder="地址" value="${c.name}" ></input>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="idcard"
					name="idcard" placeholder="地址" value="${c.idcard}" ></input>
					</div>
		</div>
		...
		<div class="form-group">
 		...
 		<div class="form-group">
			...
			<div class="col-sm-4">
				 <textarea id="describe"  name="describe"  class="form-control" rows="3">${a.describe}</textarea>
			</div>
		</div>
