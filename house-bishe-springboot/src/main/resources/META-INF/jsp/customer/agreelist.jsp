...
<html>
	...
	$(document).ready(function(){
		$.post("<%=basePath%>customer/agreeList",function(data){//获取json数据
		var data = eval("("+data+")");
		tableInit(data);
	});
...
<body>
    ...
    <script>
                ...
                columns: [{
                   ...
                   field: 'status',
                	...
                	formatter: function (value, row, index) {
                        ...
                        'click .getDetail': function (e, value, row, index) {
                        	 LookProvider(row.provider_id);//调用details(sno)
                        }
                    }
                } 
        ...
        detail= function(agreement_id) {
        	window.location.href ="<%=basePath%>customer/getOneAgree/"+agreement_id+"?agreement_id="+agreement_id;
        };
       LookProvider= function(provider_id){
        window.location.href ="<%=basePath%>customer/getOneProvider/"+provider_id+"?provider_id="+provider_id;
        }; 
