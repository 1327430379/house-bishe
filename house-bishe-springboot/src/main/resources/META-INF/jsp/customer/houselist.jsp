...
<body>
    ...
    </div><div style="padding-top: 50px;padding-right: 20px;">当前用户：&nbsp;<font color="red">${currentUser} </font>&nbsp&nbsp<a href="Logout">注销</a></div>
    ...
    <script>
                ...
                columns: [{
                   ...
                   field: 'price',
                	...
                	formatter: function (value, row, index) {
                        ...
                        'click .getDetail': function (e, value, row, index) {
                           detail2(row.house_id);//调用details(sno)
                        }
                    }
                }
        ...
        detail= function(house_id) {
        	window.location.href ="<%=basePath%>provider/getOneHouse/"+house_id+"?house_id="+house_id;
        };
        detail2= function(house_id) {
        	window.location.href ="<%=basePath%>provider/getOneHouse2/"+house_id+"?house_id="+house_id;
        };
