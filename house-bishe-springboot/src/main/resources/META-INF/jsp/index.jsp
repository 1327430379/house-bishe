	...
	$(function(){
		$(".city-wrap").click(function(){
			$.layer({
			    ...
			    page: {html : '<div style="width: 572px; height: 261px; float: left;padding:10px;"><ul style="width: 572px; height: 261px; float: left;" id="city_ul"><li class="check" area_id=2>福州</li><li class="encheck" area_id=1650>厦门</li><li class="encheck" area_id=1650>泉州</li><li class="encheck" area_id=1650>漳州</li><li class="encheck" area_id=1650>莆田</li></ul></div>'},
			    shift: 'top', //从上动画弹出
			    shadeClose :true,
			    closeBtn:[1,true]
...
<div class="main2"> 
	...
	<!--这里显示 就是重点编程的对象-->
    	<form method="post" action="<%=basePath%>search2.do" >
            <div class="fl">
             <input type="hidden" name="city" value="福州市">
                <input class="kuang" type="text" id="key"  name="key"  placeholder="请输入房源特征，地址或小区名。" value="${key }">
            </div>
            
            <div class="fl" >
            	<!-- <input type="hidden" name="type" value="1"> type="image"   images/ss.png-->
                <input type="image" src="${pageContext.request.contextPath}/images/ss.png"    />
            </div>
        ...
        <div class="conditions">
        	<div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                ...
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu1/')">鼓楼</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu2/')">仓山</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu3/')">晋安</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu4/')">马尾</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu5/')">台江</div>
                           
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu6/')">长乐</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch1/gqu7/')">福清</div>
                               <div class=" item fl pointer" onClick="">平潭</div>
                            
                                <div class=" item fl pointer" onClick="')"> 县闽侯县</div>
                               <div class=" item fl pointer" onClick="">连江县 </div>
                                  <div class=" item fl pointer" onClick="">罗源县</div>
                                <div class=" item fl pointer" onClick=""> 闽清县</div>
                               <div class=" item fl pointer" onClick="">永泰县 </div>
                                <div class="cb"></div>
            </div>
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                 ...
                                 <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp1/')">250以下</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp2/')">250-350</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp3/')">350-450</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp4/')">450-600</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp5/')">600-800</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch2/gp6/')">800-1000</div>
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch3/ga1/')">30平米以下</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch3/ga2/')">30-40平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch3/ga3/')">40-60平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch3/ga4/')">60-80平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch3/ga5/')">80-100平米</div>
            ...
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch4/gs1/')">一室</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch4/gs2/')">二室</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>guisearch4/gs3/')">三室</div>
                                <div class=" item fl pointer" onClick="href('')">四室</div>
                                <div class=" item fl pointer" onClick="">五室</div>
                                <!--ref('/index/secondhand/rsf.html?nav=2&com=&price=&area=&house=last&type=1&ty=&xuequ=&video=&yt=')  -->
                                <div class="cb"></div>
            </div>
...
<div class="main3">
        ...
        <c:forEach var="h" items="${list}" varStatus="status">
			...
			<a class="num" href="/secondhand/index/nav/2/type/1/p/1.html">2</a>
			<a class="num" href="/secondhand/index/nav/2/type/1/p/3.html">3</a>
			<a class="num" href="/secondhand/index/nav/2/type/1/p/4.html">4</a>
			<a class="num" href="/secondhand/index/nav/2/type/1/p/5.html">5</a>

			
			<a class="next" href="/secondhand/index/nav/2/type/1/p/3.html">>></a>
			 <a class="end" href="/secondhand/index/nav/2/type/1/p/3799.html">6</a></div> 
        </div> --%>
         <div class="page_list_think" style="margin-top:35px;"> 
			<div> <a class="prev" href="<%=basePath%>indexlist.do"><<</a> 
			<c:forEach begin="1" end="${total}"  step="1" varStatus="i"><!-- class="showimg"  --><%-- <%=basePath%>indexfenye.do?num=${i.index} --%>
                     <a href="<%=basePath%>indexfenye.do/1/${i.index}/"     
