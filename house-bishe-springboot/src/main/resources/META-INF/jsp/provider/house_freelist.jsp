...
<html>
	...
	$(document).ready(function(){
		$.post("<%=basePath%>provider/freeHouseList",function(data){//获取json数据
		var data = eval("("+data+")");
		tableInit(data);
	});
...
<body>
    ...
    <script>
        ...
        $(function () {
          ...
          /*"<%=basePath%>jsp/provider/addAgree.jsp?house_id="+house_id */
        detail= function(house_id) {
     
        	window.location.href ="<%=basePath%>provider/getid?house_id="+house_id;
        };
