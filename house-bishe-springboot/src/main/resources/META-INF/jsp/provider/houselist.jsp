    ...
    <script>
        ...
        $(function () {
            $button.click(function () {//获取删除的多选框里里面的值,将值传给:url:"deleteMembers",
                ...
                $.ajax({
                	url:"<%=basePath%>provider/HouseDeletes",
                	data:{
                		idsStr:house_idsStr//servlet获取的参数
                	},
        ...
        detail=function(house_id) {
        	window.location.href ="<%=basePath%>provider/getOneHouse/"+house_id+"/";
        	
        };
        detail2=function(house_id) {
        	//alert(house_id);
        	window.location.href ="<%=basePath%>provider/getOneHouse2/"+house_id+"/";
        };
