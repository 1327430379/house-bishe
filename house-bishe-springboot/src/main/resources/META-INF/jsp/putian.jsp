  ...
  <div class="header-main-inner">
    ...
    <div class="header-main-l">
      ...
      <div class="slogan" style="height:45px; overflow:hidden;margin-top: 46px;">
      	<a href="index/yidong.html"><img src="images/yidong.png" width="" height="100"  alt="移动租房网"></a>
      </div>
      
    </div>
    
    <div class="header-main-r" style="height: 50px; padding-top: 39px;">
    	<a href="#" style="font-family: 'Hiragino Sans GB','Microsoft Yahei UI','Microsoft Yahei','微软雅黑','Segoe UI',Tahoma,'宋体b8b\4f53',SimSun,sans-serif; color: #888; text-decoration: none;"><img src="images/chengnuo.png">房地产中介诚信服务承诺</a>
    </div>
  </div>
</div>
<!-- 导航栏 -->
...
<div class="main2"> 
	<div class="sousuo2">
	<!--这里显示 就是重点编程的对象-->
    	<form method="post" action="<%=basePath%>search.do" >
            <div class="fl">
            <input type="hidden" name="city" value="来宾市">
        ...
        <div class="conditions">
        	<div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('')">兴宾区</div>
            ...
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('')">250以下</div>
                                <div class=" item fl pointer" onClick="href('')">250-350</div>
                                <div class=" item fl pointer" onClick="href('')">350-450</div>
                                <div class=" item fl pointer" onClick="href('')">450-600</div>
                                <div class=" item fl pointer" onClick="href('')">600-800</div>
                                <div class=" item fl pointer" onClick="href('')">800-1000</div>
                                <div class=" item fl pointer" onClick="href('')">1000以上</div>
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('')">30平米以下</div>
                                <div class=" item fl pointer" onClick="href('')">30-40平米</div>
                                <div class=" item fl pointer" onClick="href('')">40-60平米</div>
                                <div class=" item fl pointer" onClick="href('')">60-80平米</div>
                                <div class=" item fl pointer" onClick="href('')">90-110平米</div>
            ...
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('')">一室</div>
                                <div class=" item fl pointer" onClick="href('')">二室</div>
                                <div class=" item fl pointer" onClick="href('')">三室</div>
                                <div class=" item fl pointer" onClick="href(')">四室</div>
                                <div class=" item fl pointer" onClick="href('/index/secondhand/rsf.html?nav=2&com=&price=&area=&house=last&type=1&ty=&xuequ=&video=&yt=')">五室</div>
                                <div class="cb"></div>
            </div>
...
<div class="main3">
        ...
        <c:forEach var="h" items="${list}" varStatus="status">
        	...
        	<div class="item3Left fl pointer" style="position:relative" onClick="window.location.href='<%=basePath %>index_getOneHouse/${h.house_id }/'">
            ...
            <div class="item3Right fl"><!--http://##.com/index/secondhand/houseinfo.html?id=31162&nav=2 该链接是打开查看商品信息详情的  -->
            	<div class="i3d1 pointer" onClick="return;window.open('<%=basePath %>index_getOneHouse/${h.house_id }/')">
                	<h1><a href="<%=basePath %>index_getOneHouse?house_id=${h.house_id }" target="_blank">
                    	${ h.address} 出租 ${h.type } ${h.area }平米    ${h.price }/月                </a></h1>
                </div>
                <div class="i3d2">
                						${ h.address}                                        &nbsp;&nbsp;&nbsp;
                   ${ h.address2}         &nbsp;&nbsp;  ${ h.park}    </div>
                <div class="i3d3">
                <!--灵川八里4路大圆盘旁边      &nbsp;&nbsp;&nbsp; --> 	               
					<label style="color:#009de8" ><a target="_blank"  href="http://api.map.baidu.com/geocoder?address=福州市安新小区&output=html&src=福州市安新小区">查看地图</a></label>
                &nbsp;&nbsp;&nbsp; 附近美食：${ h.eat}  &nbsp;&nbsp;附近医院：${ h.hospital}  
    ...
    <div class="m3Right fl">
    	<div class="pointer" onClick="href('/sell.html')">
        	...
        	<a href="http://www.zhaikj.com" target="_blank">
            	<img src="images/57b6c58f5ad20.jpg" width="250" >
            </a>
        	</div>
                	<div class="m3rd2 pointer">
        	<a href="http://www.pupu168.com/" target="_blank">
            	<img src="images/57b6c5da256a2.jpg" width="250" >
            </a>
        	</div>
       ...
       <div class="m3rd2">
            ...
            <div class="content">
            	<div class="cItem0 pointer" onClick="href('/zulin/houseinfo.html?id=3&nav=8')">
                	<div class="cItem0Left fl">
                    	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                    </div>
                    ...
                    <div class="cb"></div>
                                ...
                                <div class="cItem pointer" onClick="href('/zulin/houseinfo.html?id=4&nav=8')">
                	<div class="cItemd1 fl">澳洲假日3室2厅2卫2台出租</div>
                    <div class="cItemd2 fl">3房2厅</div>
                                        <div class="cItemd3 fr">2300元/月</div>
                                        <div class="cb"></div>
                </div>
                                <div class="cItem pointer" onClick="href('/zulin/houseinfo.html?id=2&nav=8')">
                	<div class="cItemd1 fl">鑫海国际1室1厅1卫出租</div>
                    <div class="cItemd2 fl">1房1厅</div>
                                        <div class="cItemd3 fr">950元/月</div>
                                        <div class="cb"></div>
                </div>
                                <div class="cItem pointer" onClick="href('/zulin/houseinfo.html?id=5&nav=8')">
                	<div class="cItemd1 fl">八里街 城北菜市商住楼 3室2厅1卫0台 出租</div>
                    <div class="cItemd2 fl">3房2厅</div>
                                        <div class="cItemd3 fr">1200元/月</div>
                                        <div class="cb"></div>
                </div>
                                <div class="cItem pointer" onClick="href('/zulin/houseinfo.html?id=6&nav=8')">
                	<div class="cItemd1 fl">象山区 安厦尚城风景 二机厂宿舍 2室1厅1卫0台 出租</div>
	    ...
	    <div class="m3rd3">
        	<div class="title2">
                ...
                <div class="cb"></div>
                        ...
                        <div class="content2 pointer" onClick="href('/zulin/houseinfo.html?id=7&nav=8')">
            	<div class="content2Img">
                	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                </div>
                <div style="margin-top:5px; font-weight:bold">
                	<div class="fl" style="width:140px; height:14px; overflow:hidden;">象山区 平山 丰泽苑 3室2厅2卫0台 出租</div>
                ...
                <div>
                	125平米&nbsp;3房2厅
                        ...
                        <div class="content2 pointer" onClick="href('/zulin/houseinfo.html?id=8&nav=8')">
            	<div class="content2Img">
                	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                </div>
                <div style="margin-top:5px; font-weight:bold">
                	<div class="fl" style="width:140px; height:14px; overflow:hidden;">象山区 安厦世纪城 揽翠湾 1室1厅1卫0台 </div>
                ...
                <div>
                	20平米&nbsp;1房1厅
                        ...
                        <div class="content2 pointer" onClick="href('/zulin/houseinfo.html?id=9&nav=8')">
            	<div class="content2Img">
                	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                </div>
                <div style="margin-top:5px; font-weight:bold">
                	<div class="fl" style="width:140px; height:14px; overflow:hidden;">七星区 施家园 龙隐I区 1室1厅1卫0台 </div>
                ...
                <div>
                	123平米&nbsp;1房1厅
                        ...
                        <div class="content2 pointer" onClick="href('/zulin/houseinfo.html?id=10&nav=8')">
            	<div class="content2Img">
                	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                </div>
                <div style="margin-top:5px; font-weight:bold">
                	<div class="fl" style="width:140px; height:14px; overflow:hidden;">七星区 屏风花鸟市场 建干路 1室1厅1卫0台 </div>
                ...
                <div>
                	78平米&nbsp;1房1厅
                        ...
                        <div class="content2 pointer" onClick="href('/zulin/houseinfo.html?id=11&nav=8')">
            	<div class="content2Img">
                	<img src="images/no_img.jpg" style="width:100%; height:100%;">
                </div>
                <div style="margin-top:5px; font-weight:bold">
                	<div class="fl" style="width:140px; height:14px; overflow:hidden;">七星区 三里店 公园绿涛湾东园 2室1厅1卫0台 </div>
                	                    <div class="fr" style="color:#f25336">2000元/月</div>
                                        <div class="cb"></div>
                </div>
                <div>
...
<div id="footer">
  ...
  <div class="link" style="width:960px; margin:0 auto; margin-top:30px; margin-bottom:20px;">
        ...
        <div style="float:left; width:900px;">
                    <a href="http://esf.guilin.fang.com/" style="padding-right:8px; padding-left:8px;white-space:nowrap; width:75px; overflow:hidden; color:#000000;" target="_blank">福州搜房网二手房</a>
