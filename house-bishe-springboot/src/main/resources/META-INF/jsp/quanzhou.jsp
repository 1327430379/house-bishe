...
<div class="main2"> 
	...
	<!--这里显示 就是重点编程的对象-->
    	<form method="post" action="<%=basePath%>search2.do" >
            <div class="fl">
            <input type="hidden" name="city" value="泉州">
        ...
        <div class="conditions">
        	<div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_qu/gqu1/')">丰泽区</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_qu/gqu2/')">鲤城区</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_qu/gqu3/')"> 晋江市</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_qu/gqu4/')">洛江区</div>
                               <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_qu/gqu5/')">泉港区</div>
                                <div class=" item fl pointer" onClick="href('')">其他</div>
            ...
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp1/')">250以下</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp2/')">250-350</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp3/')">350-450</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp4/')">450-600</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp5/')">600-800</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp6/')">800-1000</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_price/gp7/')">1000以上</div>
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_area/ga1/')">30平米以下</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_area/ga2/')">30-40平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_area/ga3/')">40-60平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_area/ga4/')">60-80平米</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_area/ga5/')">90-110平米</div>
            ...
            <div class="conditionsDiv">
                ...
                <div class="current2 item fl pointer" onClick="href('')">不限</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_shi/gs1/')">一室</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_shi/gs2/')">二室</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_shi/gs3/')">三室</div>
                                <div class=" item fl pointer" onClick="href('<%=basePath %>quanzhou_shi/gs4/')">四室</div>
                                <div class=" item fl pointer" onClick="href('')">五室</div>
                                <div class="cb"></div>
            </div>
